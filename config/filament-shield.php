...
return [
    ...
    */
    ...
    |
    | The super admin is an ordinary role holding every permission, rather
    | than a gate that short-circuits the checks. This keeps the Roles screen
    | honest: what is ticked there is exactly what the role can do, so access
    | can be audited and narrowed like any other role.
    |
    | The cost is that the role does not know about permissions that did not
    | exist when it was granted. Adding a resource therefore takes two steps
